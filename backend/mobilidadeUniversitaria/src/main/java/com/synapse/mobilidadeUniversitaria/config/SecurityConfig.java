    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/students/**").hasAnyRole("GESTOR", "ALUNO")
                        .requestMatchers("/api/reports/**").hasRole("GESTOR")
                        .requestMatchers("/api/documents/**").hasAnyRole("GESTOR", "ALUNO", "MOTORISTA")
                        .requestMatchers("/api/system/**").hasRole("GESTOR")
                        .requestMatchers("/api/notifications/**").hasAnyRole("GESTOR", "ALUNO", "MOTORISTA")
